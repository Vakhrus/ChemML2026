...
best_params = {
    "Best parametrs": grid_search.best_params_,
    "Best R^2 (CV)": round(grid_search.best_score_, 4)
}

# Лучшие параметры в JSON
with open("results/best_params.json", "w") as f:
    json.dump(best_params, f, indent=2)
print("\nЛучшие параметры сохранены в results/best_params.json")